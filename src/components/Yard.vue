<template>
  <div class="main" :style="{ backgroundColor: backgroundColor }">
    <i style="z-index: 2; position: absolute; top: 25px; right: 25px; font-size: 30px; background-color: black; color: white" @click="backMain" class="el-icon-close"></i>
    <div class="weather">
